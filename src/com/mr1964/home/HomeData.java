...
//	private String ERROR = "0";
	...
	public String DataAction(int i,String user_id){		
		try{
			...
			/*String sql = "select * from messages where user_id in " +
					"(select user2_id from follow where user1_id = " + 
					user_id +") order by message_id desc limit"+i+",10";*/
			
			String sql = "select * from messages where user_id in " +
					"(select user2_id from follow where user1_id = " +user_id+
